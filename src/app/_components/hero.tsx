                ...
                <article className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                    ...
                    <div className="space-y-6">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-10"
                            data-aos="fade-down"
                        > Seu pet merce cuidado, carinho e atenção especial.</h1>

                        <p className="lg:text-lg"       
                        data-aos="fade-right">
                            Oferecemos os melhores serviços para garantir o bem-estar e a feliciadade do seu amigo de quartro patas.
                        </p>
